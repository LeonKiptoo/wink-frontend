export default function handler(req, res) {
  ...
  const rawApiBaseUrl = process.env.API_BASE_URL || "https://wnkia-backend-production.up.railway.app";
  const apiBaseUrl = rawApiBaseUrl && !/^https?:\/\//i.test(rawApiBaseUrl) ? `https://${rawApiBaseUrl}` : rawApiBaseUrl;
